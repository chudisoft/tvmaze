...
**[Tvmaze]** is a project that allows one to store and manage list of game scores.
...
> This Project is deployed at [Github Pages](https://chudisoft.github.io/tvmaze/dist/)
...
```sh
  git clone git@github.com:chudisoft/tvmaze.git
  cd tvmaze
  code .
```
-
